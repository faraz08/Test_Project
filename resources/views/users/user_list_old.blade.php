...
@section('content')
        ...
        <div class="box">
            <div class="box-header">
                ...
                <button type="button" class="btn btn-info pull-right" data-toggle="modal"
                        data-target="#modal-add-new-user">
                    Add New User
                </button>
                @endrole
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{route('user-status-change')}}" method="POST">
                                    ...
                                    <select class="form-control" name="status" id="status" onchange="this.form.submit()" {{(Auth::user()->isAdmin()) ? '' : 'disabled' }} >
                                        @foreach($status as $single_status)
                                            <option {{($single_status == $users->status) ? 'selected' : ''}} value="{{$single_status}}" >{{$single_status}}</option>
                                        @endforeach
                                    </select>
                                </form>
                            </td>
                            ...
                            <td>
                                <div class="tools">
                                    ...
                                    @endpermission
                                    @permission('delete')
                                    <a type="button" class="btn btn-default btn-xs bg-red user-del" id="{{$users->id}}"><i class="fa fa-trash-o"></i>
                                        Delete</a>
                                    @endpermission
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="box-body form-element">
                            <form method="POST" action="{{ route('register-user') }}" class="form-element" id="save-user">
                                @csrf
    ...
    <section class="content">
                            ...
                            <td>
                                <div class="tools">
                                    <button type="button"
                                            ...
                                            class="btn btn-default btn-xs bg-blue modal-department-details" ><i class="fa fa-edit"></i> Details</button>
                                    <a type="button" class="btn btn-default btn-xs bg-red department-del" id="{{$department->id}}"><i class="fa fa-trash-o"></i>
                                        Delete</a>
                                </div>
                            </td>
                            @endrole
        ...
        <div class="modal fade" id="modal-add-new-department">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="box-body form-element">
                            <form method="POST" action="{{ route('register-department') }}" class="form-element" id="register-department">
                                @csrf
                                <div class="form-group has-feedback">
        ...
        <!-- /.modal -->
        <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="modal-department-details">
